                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <h4> Marks out of  </h4>
                                    <input class="form-control" id="ex1" type="text" name="intro_marks"> <span> /20 </span> 
                                </div>

                                <div class="col-sm-6">
                                    <h4> Comments: </h4>
                                    <textarea class="form-control" rows="5" id="comment" name="intro_comments"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <h4> Marks out of  </h4>
                                    <input class="form-control" id="ex1" type="text" name="methodology_marks"> <span> /20 </span> 
                                </div>

                                <div class="col-sm-6">
                                    <h4> Comments: </h4>
                                    <textarea class="form-control" rows="5" id="comment" name="methodology_comments"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <h4> Marks out of  </h4>
                                    <input class="form-control" id="ex1" type="text" name="project_marks"> <span> /20 </span> 
                                </div>

                                <div class="col-sm-6">
                                    <h4> Comments: </h4>
                                    <textarea class="form-control" rows="5" id="comment" name="project_comments"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <h4> Marks out of  </h4>
                                    <input class="form-control" id="ex1" type="text" name="progress_marks"> <span> /20 </span> 
                                </div>

                                <div class="col-sm-6">
                                    <h4> Comments: </h4>
                                    <textarea class="form-control" rows="5" id="comment" name="progress_comments"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <h4> Marks out of  </h4>
                                    <input class="form-control" id="ex1" type="text" name="written_marks"> <span> /20 </span> 
                                </div>

                                <div class="col-sm-6">
                                    <h4> Comments: </h4>
                                    <textarea class="form-control" rows="5" id="comment" name="written_comments"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <input class="form-control" id="ex1" type="text" name="proposalTotal"> <span> /10 </span> 
                                </div>

                                <div class="col-sm-6">
                                    <h4> Overall Comments: </h4>
                                    <textarea class="form-control" rows="5" id="comment" name="proposalComments"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
