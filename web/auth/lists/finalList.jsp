...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <h1> List of final report assessments </h1>
            <br/>
            
            <a href="<%=application.getContextPath()%>/auth/forms/finalReportAssessment.jsp"> Add Final report Assessment</a> 
            
            <h2> Final report assessments waiting for review</h2>
            <table class="table">
                <thead>
                    <tr>
        ...
        <hr>
        <div class="container">
            <h2> Final report assessments reviewed</h2>
            <table class="table">
                <thead>
                   <tr>
                        <th>Firstname</th>
